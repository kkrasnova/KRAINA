...
const T_VANGOGH_MUSEUM = require('./assets/vangogh-museum-facade.webp');
const T_RIJKSMUSEUM = require('./assets/rijksmuseum-facade.webp');
const T_VONDELPARK = require('./assets/vondelpark-hero.webp');
const T_WESTERKERK = require('./assets/westerkerk-hero.webp');
const T_ANNE_FRANK_HOUSE = require('./assets/anne-frank-house-hero.webp');
...
Object.assign(MAIDAN_STORY, {
  homeHeroHeightRatio: 0.68,
  homeHeroHeightMax: 800,
...
export const ROUTE_REGIONS = {
  ...
  lviv: {
    ...
    landmarks: [
      ...
      {
        id: 'lviv_old_town_of_lviv',
        titleUk: 'історичний центр Львова',
        titleEn: 'Old Town of Lviv',
        lat: 49.841667,
        lng: 24.031944,
        minutes: 45,
        free: true,
        thumb: T1,
        distKm: 0.3,
        descUk: 'перший район Львова, де було засновано місто',
        descEn: 'historic centre of the western Ukrainian city of Lviv',
      },
      {
        id: 'lviv_saint_george_s_cathedral',
        titleUk: 'Собор святого Юра',
        titleEn: 'Saint George\'s Cathedral',
        lat: 49.838611,
        lng: 24.013056,
        minutes: 40,
        free: true,
        ...
        distKm: 1.2,
        descUk: 'cathedral',
        descEn: 'Ukrainian Greek Catholic church in Lviv',
      },
      {
        id: 'lviv_armenian_cathedral_of_lviv',
        titleUk: 'Вірменський собор (Львів)',
        titleEn: 'Armenian Cathedral of Lviv',
        lat: 49.843333,
        lng: 24.030833,
        minutes: 40,
        free: true,
        thumb: T3,
        distKm: 0.4,
        descUk: 'колишня вірмено-католицька катедра у Львові',
        descEn: 'Cathedral of Armenian Apostolic Church in Lviv, Ukraine',
      },
      {
        id: 'lviv_latin_cathedral',
        titleUk: 'Латинський катедральний собор',
        titleEn: 'Latin Cathedral',
        lat: 49.840556,
        lng: 24.030556,
        minutes: 40,
        free: true,
        thumb: T4,
        distKm: 0.1,
        descUk: 'Catholic cathedral',
        descEn: 'cathedral in Lviv, in western Ukraine',
      },
      {
        id: 'lviv_lviv_national_museum',
        titleUk: 'Національний музей у Львові імені Андрея Шептицького',
        titleEn: 'Lviv National Museum',
        lat: 49.843056,
        lng: 24.028056,
        minutes: 55,
        free: false,
        thumb: T1,
        distKm: 0.4,
        descUk: 'художній музей у Львові',
        descEn: 'art museum in Lviv, Ukraine',
      },
      {
        id: 'lviv_lviv_railway_station',
        titleUk: 'головний залізничний вокзал (Львів)',
        titleEn: 'Lviv railway station',
        lat: 49.839803,
        lng: 23.994517,
        minutes: 45,
        free: true,
        thumb: T2,
        distKm: 2.5,
        descUk: 'залізнична станція',
        descEn: 'railway station',
      },
      {
        id: 'lviv_dormition_church',
        titleUk: 'Церква Успіння Пресвятої Богородиці (Львів)',
        titleEn: 'Dormition Church',
        lat: 49.842064,
        lng: 24.034456,
        minutes: 40,
        free: true,
        thumb: T3,
        distKm: 0.4,
        descUk: 'церква у Львові',
        descEn: 'church in Ukraine',
      },
      {
        id: 'lviv_dominican_church',
        titleUk: 'Костел і монастир домініканців',
        titleEn: 'Dominican Church',
        lat: 49.842778,
        lng: 24.034167,
        minutes: 40,
        free: true,
        thumb: T4,
        distKm: 0.5,
        descUk: 'Eastern Orthodox church building',
        descEn: 'church in Lviv, Ukraine',
      },
      {
        id: 'lviv_lviv_town_hall',
        titleUk: 'Львівська ратуша',
        titleEn: 'Lviv Town Hall',
        lat: 49.841835,
        lng: 24.031326,
        minutes: 55,
        free: false,
        thumb: T1,
        distKm: 0.3,
        descUk: 'адміністративний будинок у центральній частині Львова, на площі Ринок, 1',
        descEn: 'building in Lviv, Ukraine',
      },
      {
        id: 'lviv_jesuit_church',
        titleUk: 'Костел єзуїтів',
        titleEn: 'Jesuit Church',
        lat: 49.8415,
        lng: 24.0291,
        minutes: 40,
        free: true,
      ...
      {
        id: 'lviv_borys_voznytskyi_lviv_national_art_gallery',
        titleUk: 'Львівська національна галерея мистецтв імені Бориса Возницького',
        titleEn: 'Borys Voznytskyi Lviv National Art Gallery',
        lat: 49.837017,
        lng: 24.025308,
        minutes: 55,
        free: false,
      ...
      {
        id: 'lviv_bernardine_church_and_monastery',
        titleUk: 'Костел і монастир бернардинів (Львів)',
        titleEn: 'Bernardine Church and Monastery',
        lat: 49.839444,
        lng: 24.034722,
        minutes: 40,
        free: true,
        ...
        distKm: 0.4,
        descUk: 'церква у Львові',
        descEn: 'monastery in Lviv',
      },
      {
        id: 'lviv_ukrainian_dramatic_theatre_of_maria_zankovetska',
        titleUk: 'Національний академічний український драматичний театр імені Марії Заньковецької',
        titleEn: 'Ukrainian Dramatic Theatre of Maria Zankovetska',
        lat: 49.84395,
        lng: 24.027244,
        minutes: 55,
        free: false,
        thumb: T1,
        distKm: 0.5,
        descUk: 'theatre building',
        descEn: 'theatre company and theatre building in Lviv, Ukraine',
      },
      {
        id: 'lviv_lviv_les_kurbas_academic_theater',
        titleUk: 'Львівський академічний театр імені Леся Курбаса',
        titleEn: 'Lviv Les Kurbas Academic Theater',
        lat: 49.842,
        lng: 24.0254,
        minutes: 55,
        free: false,
        ...
        distKm: 0.4,
        descUk: 'theatre building',
        descEn: 'theater in Ukraine',
      },
      {
        id: 'lviv_golden_rose_synagogue',
        titleUk: 'Золота Роза',
        titleEn: 'Golden Rose Synagogue',
        lat: 49.846111,
        lng: 24.029722,
        minutes: 40,
        free: true,
        thumb: T3,
        distKm: 0.7,
        descUk: 'юдейська релігійна споруда',
        descEn: 'former synagogue in Lviv, Ukraine',
      },
      {
        id: 'lviv_eaglets_cemetery',
  ...
  amsterdam: {
    ...
    landmarks: [
      ...
      {
        id: 'vangogh',
        titleUk: 'Музей Van Gogh',
        titleEn: 'Van Gogh Museum',
        lat: 52.3584,
        lng: 4.8811,
        minutes: 45,
        free: false,
        thumb: T_VANGOGH_MUSEUM,
        distKm: 0.4,
        descUk: 'Найбільша колекція робіт Ван Гога у світі.',
        descEn: "The world's largest collection of Van Gogh's works.",
      },
      {
        id: 'vondelpark',
        titleUk: 'Vondelpark',
        ...
        thumb: T_VONDELPARK,
        distKm: 0.5,
        descUk: 'Головний парк міста — ідеальна пауза між музеями.',
        descEn: "The city's main park — a perfect pause between museums.",
      },
      {
        id: 'anne_frank',
        titleUk: 'Будинок Anne Frank',
        titleEn: 'Anne Frank House',
        lat: 52.3752,
        lng: 4.884,
        minutes: 40,
        free: false,
        thumb: T_ANNE_FRANK_HOUSE,
        distKm: 0.6,
        descUk: 'Меморіальний музей у Jordaan — історія, яку варто почути.',
        descEn: 'Memorial museum in the Jordaan — a story worth hearing.',
      },
      {
        id: 'dam_square',
        titleUk: 'Dam Square',
        ...
        thumb: T3,
        distKm: 0.3,
        descUk: 'Серце Амстердама — Royal Palace і головна площа.',
        descEn: 'Heart of Amsterdam — Royal Palace and the main square.',
      },
      {
        id: 'westerkerk',
        titleUk: 'Westerkerk',
        ...
        thumb: T_WESTERKERK,
        distKm: 0.4,
        descUk: 'Ренесансна церква біля Jordaan з високою вежою.',
        descEn: 'Renaissance church near the Jordaan with a tall tower.',
      },
    ],
  },
  waalwijk: {
