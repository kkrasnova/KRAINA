...
export async function createRouteForUser(userId, body) {
    ...
    try {
        ...
        if (body.points?.length) {
            await RoutePoint.bulkCreate(body.points.map((p) => ({
                route_id: route.id,
...
export async function deleteRouteForUser(userId, routeId) {
...
//# sourceMappingURL=routesCrudService.js.map