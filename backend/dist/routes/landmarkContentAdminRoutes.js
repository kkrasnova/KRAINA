...
import { getLandmarkContentBundle, hasLandmarkContentBundle, listLandmarkMedia, saveLandmarkContentBundle, saveLandmarkMedia, removeLandmarkMedia, } from '../services/landmarkContentAdminService.js';
...
const router = Router();
router.get('/bundle', adminActionRateLimiter, authenticateToken, requireAdmin, async (_req, res, next) => {
    try {
...
router.put('/bundle', adminActionRateLimiter, authenticateToken, requireAdmin, async (req, res, next) => {
    try {
...
router.get('/media', adminActionRateLimiter, authenticateToken, requireAdmin, async (_req, res, next) => {
    try {
...
router.post('/media', adminActionRateLimiter, authenticateToken, requireAdmin, upload.single('file'), async (req, res, next) => {
    try {
        const f = req.file;
        if (!f || !f.buffer) {
...
router.delete('/media/:name', adminActionRateLimiter, authenticateToken, requireAdmin, async (req, res, next) => {
    try {
...
//# sourceMappingURL=landmarkContentAdminRoutes.js.map