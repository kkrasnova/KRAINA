 ...
 */
export function initStorageProvider() {
    if (provider)
        return provider;
...
export function getStorageProvider() {
    if (!provider) {
        throw new Error('StorageProvider not initialised. Call initStorageProvider() during startup.');
    }
    return provider;
}
/**
 ...
 */
export async function destroyStorageProvider() {
