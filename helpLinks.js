 ...
 * Пріоритет: EXPO_PUBLIC_* → expo.extra у app.json → резерв (маркетинговий сайт релізу).

 * Для продакшену задайте EXPO_PUBLIC_KRAINA_SITE_URL або extra.krainaSiteUrl / helpFaqUrl / helpDocsUrl.
